        ...
        <div className="min-h-screen flex">
            <aside className="w-64 bg-white border-r p-4">
                ...
                <nav className="flex flex-col gap-2">
                    ...
                    <Link to="/admin/po" className="py-2 px-3 rounded hover:bg-gray-100">Purchase Order</Link>
                    <Link to="/admin/donations" className="py-2 px-3 rounded hover:bg-gray-100">Donasi</Link>
